<html>
 <head>
<link type="text/css" rel="stylesheet" href="C:\xampp\htdocs\HTML_CV(sample)\index.css"/>
<title></title> 
</head>
<body> <?php
<div id="header">
<p id="name">Deep Laxman Sukhwani</p>
     ...
     <div class="right">
            ...
            <p>
            <ul>
                <li> going through CS253 – Web Application Engineering and CS61A – Structure & Interpretation of Computer Programs</li>
